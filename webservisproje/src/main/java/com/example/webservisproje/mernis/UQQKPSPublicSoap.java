...
public class UQQKPSPublicSoap
{
    ...
    public UQQKPSPublicSoap(){}

    public UQQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UQQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UQQExtendedSoapSerializationEnvelope envelope= new UQQExtendedSoapSerializationEnvelope(UQQExtendedSoapSerializationEnvelope.VER11);
