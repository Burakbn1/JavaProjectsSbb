...
class UQQSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class UQQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UQQDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new UQQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UQQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UQQDateTimeConverter dateTimeConverter = new UQQStandardDateTimeConverter();

    public UQQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UQQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UQQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UQQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UQQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UQQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
