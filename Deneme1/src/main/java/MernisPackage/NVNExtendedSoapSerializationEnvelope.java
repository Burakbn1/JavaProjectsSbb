...
class NVNSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class NVNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NVNDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new NVNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NVNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NVNDateTimeConverter dateTimeConverter = new NVNStandardDateTimeConverter();

    public NVNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NVNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NVNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NVNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NVNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NVNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
