...
public class NVNKPSPublicSoap
{
    ...
    public NVNKPSPublicSoap(){}

    public NVNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NVNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NVNExtendedSoapSerializationEnvelope envelope= new NVNExtendedSoapSerializationEnvelope(NVNExtendedSoapSerializationEnvelope.VER11);
